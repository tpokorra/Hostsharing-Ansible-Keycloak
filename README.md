Hostsharing-Ansible-Keycloak
============================

This Ansible playbook will install the latest Keycloak release on a server from www.hostsharing.net.
...
We clone this git-repo to our machine:
    ...
    $ git clone https://github.com/tpokorra/Hostsharing-Ansible-Keycloak.git

Then we change the working directory:

    $ cd Hostsharing-Ansible-Keycloak
